...
const styles = StyleSheet.create({
  ...
  adminNavBar: { backgroundColor: "#FFFFFF", borderTopColor: "#D9E2EC", borderTopWidth: 1, bottom: 0, elevation: 12, height: 76, left: 0, position: "absolute", right: 0, shadowColor: "#102A43", shadowOpacity: 0.12, shadowRadius: 8, shadowOffset: { width: 0, height: -3 }, zIndex: 100 }, adminNavContent: { gap: 8, paddingHorizontal: 12, paddingVertical: 10 }, adminNavItem: { alignItems: "center", borderRadius: 12, flexDirection: "row", gap: 6, minHeight: 46, paddingHorizontal: 12 }, adminNavItemActive: { backgroundColor: "#E6FFFA" }, adminNavLabel: { color: "#627D98", fontSize: 11, fontWeight: "700" }, adminNavLabelActive: { color: "#0F766E", fontWeight: "800" },
