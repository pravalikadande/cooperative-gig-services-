...
export function ProfileLanguagePicker() {
  ...
  return React.createElement(View, { style: { marginBottom: 12 } },
    React.createElement(Pressable, { accessibilityRole: "button", onPress: () => setOpen((value) => !value), style: { alignItems: "center", backgroundColor: "#F0FDFA", borderColor: "#99F6E4", borderRadius: 14, borderWidth: 1, flexDirection: "row", justifyContent: "space-between", paddingHorizontal: 14, paddingVertical: 13 } },
      React.createElement(View, { style: { flex: 1 } },
        React.createElement(Text, { style: { color: "#0F766E", fontSize: 11, fontWeight: "800", letterSpacing: 0.5, textTransform: "uppercase" } }, t("language", "Language")),
        React.createElement(Text, { style: { color: "#102A43", fontSize: 15, fontWeight: "800", marginTop: 3 } }, languageNames[language])),
      React.createElement(Text, { style: { color: "#0F766E", fontSize: 20, fontWeight: "700" } }, open ? "⌃" : "⌄")),
    open && React.createElement(View, { style: { backgroundColor: "#FFFFFF", borderColor: "#D9E2EC", borderRadius: 12, borderWidth: 1, gap: 2, marginTop: 6, padding: 6 } },
      React.createElement(Text, { style: { color: "#627D98", fontSize: 12, fontWeight: "700", paddingHorizontal: 10, paddingVertical: 6 } }, t("selectLanguage", "Select language")),
      Object.entries(languageNames).map(([code, name]) => React.createElement(Pressable, { key: code, onPress: () => { setLanguage(code as LanguageCode); setOpen(false); }, style: { backgroundColor: language === code ? "#CCFBF1" : "#FFFFFF", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 10 } }, React.createElement(Text, { style: { color: "#102A43", fontWeight: language === code ? "800" : "500" } }, name))))
  );
}
